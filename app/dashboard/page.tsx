        ...
        <div className="flex flex-col align-middle space-y-2 border border-gray-200 rounded-lg p-2">
          {lastMessages.map((message) => (
            <Link key={message.id} href={`/dashboard/chat/${message.chatId}`}>
              <div className="flex flex-col align-middle w-full p-2 md:p-3 border border-gray-200 rounded-lg bg-gray-50 hover:border-gray-400 hover:shadow-md transition-all duration-300 ease-in-out">
